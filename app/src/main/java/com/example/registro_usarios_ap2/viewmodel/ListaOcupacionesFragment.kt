...
import com.example.registro_usarios_ap2.databinding.ListaOcupacionesFragmentBinding
...
class ListaOcupacionesFragment : Fragment() {
    ...
    fun openOcupacionesFragment(ocupacion: Ocupacion?=null)  {
        val action = ListaOcupacionesFragmentDirections.actionToOcupacionesFragment2(ocupacion)
